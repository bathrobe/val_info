...
export interface Config {
  ...
  globalsSelect: {
    ...
    onePager: OnePagerSelect<false> | OnePagerSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "onePager_select".
 */
export interface OnePagerSelect<T extends boolean = true> {
  title?: T;
  bannerImage?: T;
  avatarImage?: T;
  subtitle?: T;
